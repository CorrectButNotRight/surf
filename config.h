...
static const float scrollmult = 2;
...
//             "prop=\"$(~/scripts/surf_history_dmenu.sh $1)\" &&" \
...
//"prop=\"`~/scripts/surf_history_dmenu.sh`\" &&" \
...
//	{ MODKEY,                GDK_KEY_b,      scrollv,    { .i = -50 } },
	...
	{ MODKEY|GDK_SHIFT_MASK, GDK_KEY_c,      toggleinspector, { 0 } },
...
//	{ MODKEY|GDK_SHIFT_MASK, GDK_KEY_f,      toggle,     { .i = FrameFlattening } },
  ...
  { 0                    , GDK_KEY_o,      spawn,      SETURI("_SURF_GO") },
};
